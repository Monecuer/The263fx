...
import {
  ...
  FaChartLine, FaChevronDown, FaWhatsapp
} from 'react-icons/fa';
...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 left-0 bg-black bg-opacity-80 backdrop-blur-md z-50 shadow-lg">
      ...
      {showBanner && (
        <div className="bg-blue-600 text-white text-center text-sm py-2 px-4 flex items-center justify-between">
          <p className="mx-auto">
            Hello family 👋 We’ve temporarily removed <b>Log In</b> and <b>Sign Up</b>.  
            Please contact us directly via WhatsApp below. 💙 — The263Fx Team
          </p>
          <button
          ...
          <div className="relative">
            ...
            {contactOpen && (
              <div className="absolute right-0 mt-2 w-44 bg-black/80 backdrop-blur-md text-white rounded-lg shadow-lg text-sm">
                <a
                  href="https://wa.me/263775001909?text=Hi%20The263Fx%2C%20I%20need%20assistance."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 hover:bg-blue-600/30"
                >
                  <FaWhatsapp /> WhatsApp
                </a>
              </div>
